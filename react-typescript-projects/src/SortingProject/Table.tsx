...
const Table = () => {
  ...
  const handlePageChange = (pageNubmer: number) => {
    ...
    <div className="p-4 w-[93%] ml-[5rem]">
      ...
      <div className="flex items-center  mb-5">
        ...
        <div className="relative ml-4 w-full">
          ...
          {filtersVisible && (
            <div className="mt-2 bg-gray-800 border border-gray-700 rounded shadow-lg p-4">
              <div className="mb-2">
      ...
      <div className="flex justify-end mt-4">
        <button
          ...
          className="px-4 py-2 bg-gray-700 text-white rounded mr-2 disabled:opacity-0"
        >
          Previous
        </button>
